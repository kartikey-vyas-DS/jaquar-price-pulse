...
$LambdaDir = Join-Path $Root "lambdas\price_changes_api"
$BuildDir = Join-Path $Root "build\price_changes_api"
$ZipPath = Join-Path $Root "build\price_changes_api_lambda.zip"
